...
#ifndef _GxEPD2_1160_GDEY116T91_H_
#define _GxEPD2_1160_GDEY116T91_H_

#include "../GxEPD2_4G_EPD.h"

class GxEPD2_1160_GDEY116T91 : public GxEPD2_4G_EPD
{
  public:
    // attributes
    static const uint16_t WIDTH = 960;
    static const uint16_t HEIGHT = 640;
    static const GxEPD2_4G::Panel panel = GxEPD2_4G::GDEY116T91;
